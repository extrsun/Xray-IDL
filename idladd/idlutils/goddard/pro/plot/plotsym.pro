...
;      Sep   2015    Modified the plot of down/up-ward arrows, to plot a hat SW
;-
 On_error,2
...
1:  begin                                     ;Down arrow
    xarr = [-1.5,1.5,0, 0, 0.5, 0,-0.5]*psize
    yarr = [   0,  0,0,-2,-1.4,-2,-1.4]*psize
    fill = 0
    end
2:  begin                                     ;Up arrow
    xarr = [-1.5,1.5,0,0,.5,0,-.5]*psize
    yarr = [   0,  0,0,2,1.4,2,1.4]*psize
    fill = 0
    end
3:  begin                                     ;Star

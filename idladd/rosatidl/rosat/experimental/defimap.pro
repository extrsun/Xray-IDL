...
;       rosatlib.pro.
;
;       At the Rosat GOF, ZIMAP is set equal to /caldb/data/rosat/pspc/cpf
;       on the Suns (by $ZCOM/.idlrc), and to CALDB:[DATA.ROSAT.PSPC.CPF] 
...
;  upon entering IDL
;  At the Rosat GOF, ZIMAP is set equal to /caldb/data/rosat/pspc/cpf
;  on the Suns, and to CALDB:[DATA.ROSAT.PSPC.CPF] on the Vaxen

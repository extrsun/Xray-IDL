...
;	written  07 Oct 1991 by GAR (original name rsgetseqinfo)
...
;       modified 13 Aug 1993 (GAR) to read primary header from file,
;          name changed to us_seqinfo
;-
;-------------------------------------------------------------------------------
pro us_seqinfo,fitsname,nobi,actim,nomasp,seqbeg,seqend,obibeg,obiend
;
npar = n_params(0)
if (npar eq 0) then begin
  print,' US_SEQINFO, fitsname, NOBI, ACTIM, NOMASP, SEQBEG, SEQEND, '
  print,'             OBIBEG, OBIEND'
  return
endif
;

...
#============================================================================
#  phoctrayp.sh
#Written by kachun May 23 1994; based on phoct.sh (for the options) and
#  phoctray_a.1_2.sh (for the rest of the code).
#============================================================================
...
echo $temp > $fdat
#sed -n -e /After/p $f_log | cut -c 61-71 >> $fdat
#change for the new version of xspec
#echo  $f_log $fdat

sed -n -e /"Model predicted"/p $f_log | cut -c 25-38 >> $fdat

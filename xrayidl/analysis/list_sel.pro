...
; detagname - prefix for the original coordinates of individual observations (def='m')
; mdim, mblock,,mxmin,mymin,bmin,bmax - parameters for
;                                                 output images 
; cim - output stack of images
; bexpt - background event file exposure 
;
; revision of the old list_sel by wqd May 24, 2003
; reverse the use of detagname, wqd, July 2, 2007
;-
...
for kk=0,nf-1 do begin
	...
	if nfound ne 0 then begin
	   	...
	   	,filter=filter,sel=sel,nsel=nsel,det=detagname

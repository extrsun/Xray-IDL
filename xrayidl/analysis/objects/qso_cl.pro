pro qso_cl,infile,soufile,sradius=sradius
...
openr,un,infile,/get
for i=1,5 do readf,un,str
while not eof(un) do begin
;	readf,un,str,format='(a81)'
	readf,un,str,format='(a104)'
	aa=float(strmid(str,10,4))
	radec=strmid(str,7,5)+string((aa-fix(aa))*60.)+strmid(str,14,7)+' 0'

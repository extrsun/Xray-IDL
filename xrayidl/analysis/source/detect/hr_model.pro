pro hr_model,fname,ptv,pnv,ca,tv,nv,fa,noerase=noerase,thick=thick,xtitle=xtitle,ytitle=ytitle,hrch=hrch,pch=pch,dhrch=dhrch
;+
...
print,',thick=thick,xtitle=xtitle,ytitle=ytitle,hrch=hrch,pch=pch,dhrch=dhrch'
return
endif

...
endcase
	...
	case perclimit of
	 0.5: psf_coef,blow,bhigh,coef,spfile=spfile,instr=instr,perc=perclimit
	 0.9: psf_coef,blow,bhigh,coef,spfile=spfile,instr=instr,perc=perclimit
	 else: begin
		psf_coef,blow,bhigh,coef5,spfile=spfile,instr=instr,perc=0.5
		psf_coef,blow,bhigh,coef9,spfile=spfile,instr=instr,perc=0.9

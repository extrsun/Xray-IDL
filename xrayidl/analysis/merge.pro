...
;         ,bin_size,array_c,array_b,array_t,image_c,image_b,image_t
...
pro merge,center_ra,center_dec,image_ra,image_dec,array_size_x,array_size_y $
         ,bin_size,array_1,image_1,array_2,image_2,array_3,image_3 $
...
print,',array_size_x,array_size_y,bin_size,array_1,image_1'
print,',array_2,image_2,array_3,image_3,array_4,image_4,block=block'
print,',edge_side=edge_side,keep_zero=keep_zero,,array_co=array_co,image_co=image_co'
retall
endif
;--------------------------------------------------------------------
sz=size(image_1)
image_size=sz(1) ;suppose x and y have the same size
n_images=(n_params()-7)/2
...
;
     if keyword_set(keep_zero) eq 0 then begin
...
;
	...
	if n_elements(image_co) ne 0 then $
		array_co=image_add(array_co,array_loc,image_co,image_loc)
     endfor
;

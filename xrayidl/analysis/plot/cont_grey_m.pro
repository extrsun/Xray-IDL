...
;		   y-axis to the edge of the plot device; default is .35;
...
; wqd, Jan 7, 1994
; Revision noted from Kachun July, 1994:
; The following is a revised version of cont_grey that will plot out a
; grid over the image.  The main differences between this and the old
; cont_grey is the addition of new keywords and parameters which imlabelmmm
; (the subroutine that plots the grid) needs, and the deletion of previous
; lines that calculated the astrometry for plotting the axes.  You will pro-
; bably want to save this under a different name (e.g. "cont_grey_m") in
; case you want to use the older version (since that plots nicer tickmarks
; in my opinion).
;
;-

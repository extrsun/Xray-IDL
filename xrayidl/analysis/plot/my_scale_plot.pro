pro my_scale_plot,corner,hdr,nxc,nyc,amscale,text,thick=thick,txoff=txoff,tyoff=tyoff,charsize=charsize,color=color,charthick=charthick
;-
...
; modified by ljt 10/01/07, add the charthick parameter
;+
...
xyouts,xmid+txoff,ymid+tyoff,text,/normal,align=0.5,charsize=charsize,color=color,charthick=charthick
return
end

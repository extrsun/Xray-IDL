pro multi_spec,list,outroot,evtfname=evtfname,wmapfile=wmapfile,pifile=pifile,exposure=exposure,backscal=backscal,wemin=wemin,wemax=wemax,rebin=rebin,rmfdir=rmfdir,tstart=tstart,bspecfname=bspecfname,norsp=norsp
;+
...
print,',rmfdir=rmfdir,tstart=tstart,bspecfname=bspecfname,norsp=norsp'
return 
endif

...
if nima eq 1 then ime=sqrt(imaec*fluxac) $
    ...
    endelse 
     ...
     if nc ne 0 then begin
         ...
         imagea_sel,selc,fluxac,sfluxa,/append
         if nback ne 0 then imagea_sel,selc,bfluxac,bsfluxa,/append
;         if nback ne 0 then begin
;             for k=0,nback-1 do cmap(*,*,k)=convolve(back(*,*,k),wlimg)
;             imagea_sel,selc,cmap,mmap,/append
;         endif 
...
sflux(sel)=fluxc(sel) 
imagea_sel,sel,fluxac,sfluxa,/append
if nback ne 0 then imagea_sel,sel,bfluxac,bsfluxa,/append

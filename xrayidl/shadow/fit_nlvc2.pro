pro fit_nlvc2,nhvc,countvc,backvc,timevc,xflux,bnlo=bnlo,bnhi=bnhi $
...
; foreground and background fluxes 
;
;**CALLING SEQUENCE:
...
; written by WQD, May 21, 1995
; modified version of fit_nlvc for fitting fluxes only and excluding the
;	normalization fit
;-
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

...
if max(abs(bbd)) gt 90. or max(abs(lld)) gt 360.  then begin
	print,'abs(bba) should be < 90 deg range'
	print,'abs(lla) should be < 360 deg'
	return
endif 
...
;================================================
function density,rrc,zz,gamma=gamma,tto=tto,no=no,rrsun=rrsun

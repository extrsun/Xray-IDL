pro map_nh_conf,sel,nhd,npb,ba,et,fitband,chiband,xfluxfixlo,xfluxfixhi,ninc, $
	chi,opfile=opfile
if n_elements(level) eq 0 then leveln=[1.,2.71] ;68\% and 90\% confidence levels
...
for j=0,ninc(1) do begin
	for i=0,ninc(0) do begin
		...
		nval=nval,chimin=chimin,xfluxfix=xfluxfix
	chi(i,j)=chimin

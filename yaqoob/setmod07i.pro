pro setmod07i,pfix,pnames,statnames,parfnames,outname
if n_params(0) eq 0 then begin
 print,' setmod07i,pfix,pnames,statnames,parfnames,outname '
...
statnames(0)='bba0fk_m7i_t1e5ml_200a.stat'
parfnames(0)='bba0fk_m7i_t1e5ml_200a.pars'
outname='bba0fk_m7i_t1e5ml_200a'
return
end

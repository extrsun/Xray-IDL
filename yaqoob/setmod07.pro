pro setmod07,pfix,pnames,statnames,parfnames,outname
if n_params(0) eq 0 then begin
 print,' setmod07,pfix,pnames,statnames,parfnames,outname '
 print,' Setup some stuff to input into XSTATS for mod01 simulations '
 retall
end
npar=6
pfix=intarr(npar) & pfix=[1,1,1,0,1,1]
pnames=strarr(npar)
...
statnames(0)='bba0fk_m07_t1e5_200a.stat'
parfnames(0)='bba0fk_m07_t1e5_200a.pars'
outname='bba0fk_m07_t1e5_200a'
return
end

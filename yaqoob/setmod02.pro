pro setmod02,pfix,pnames,statnames,parfnames,outname
if n_params(0) eq 0 then begin
 print,' setmod02,pfix,pnames,statnames,parfnames,outname '
...
statnames(0)='bba0fk_m02_t1e2_200a.stat'
parfnames(0)='bba0fk_m02_t1e2_200a.pars'
outname='bba0fk_m02_t1e2_200a'
return
end

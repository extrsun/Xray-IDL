...
; PURPOSE:
;
; Creates an events list of hetg events from fits table tab
;
;
; CATEGORY:
;
...
if n_params(0) eq 0 then begin
  print, 'hetglist, h, tab, plist'
  print, 'Places MARX fits event list into a plist'
  retall
endif

row = {hetgevent, time:0d0, chipx:0, chipy:0, tdetx:0, tdety:0, detx:0, $

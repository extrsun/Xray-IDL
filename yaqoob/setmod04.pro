pro setmod04,pfix,pnames,statnames,parfnames,outname
if n_params(0) eq 0 then begin
 print,' setmod04,pfix,pnames,statnames,parfnames,outname '
...
statnames(0)='bba0fk_m04_t1e4_200a.stat'
parfnames(0)='bba0fk_m04_t1e4_200a.pars'
outname='bba0fk_m04_t1e4_200a'
return
end

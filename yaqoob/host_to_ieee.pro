...
;     is since 2.2.2 when the /FTOXDR keyword  became available to BYTEORDER.
;     However, HOST_TO_IEEE should still work in earlier versions of IDL
;     Note that as of V3.0.0 there is a bug in the /DTOXDR keyword for
;     BYTEORDER on big endian machines (DecStations) so HOST_TO_IEEE has a
;     workaround.
;

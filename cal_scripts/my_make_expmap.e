...
# Outputs:
# 
# ${events_root}_c$band.fits     source counts map
# ${events_root}_i$band.fits     exposure map
# ${events_root}_f$band.fits     source flux map
# ${events_root}_fg$band.fits    smoothed source flux map
#
...
xpixelgrid="1:1024"
ypixelgrid="1:1024"
#here I have changed the caldir from "/net1/hobby/pub/cal_scripts" to "/home/ljt/ljt/software/wangastro/net1/hobby/pub/cal_scripts"
caldir=/home/ljt/ljt/software/wangastro/net1/hobby/pub/cal_scripts
